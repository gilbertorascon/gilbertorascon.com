	...
	<div class="about_wrapper max_width">
		...
		<div class="about_columns">
			<div class="column">
				...
				<p>Throughout my journey, I have enhanced my Front-End Development skills as well as my abilities in client communication and teamwork. I am currently seeking opportunities as a Junior Web Developer, Front-End Developer or Website Support Technician where I can contribute, learn, and grow.</p>
			</div>
			<div class="column">
				<h4>My Skills</h4>
				<?php
